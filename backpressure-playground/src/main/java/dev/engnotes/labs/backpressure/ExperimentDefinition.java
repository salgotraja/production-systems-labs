...
/**
 * Durable, topic-based metadata for one backpressure-playground experiment (ADR-006).
 *
 * <p>Unlike the Series 1 definition, this record carries an explicit {@code goldenDir}.
 * Series 1 derives golden paths as {@code golden/post{N}}; Series 2 nests its golden files
 * under {@code golden/bp-post{N}} so both series share the {@code golden/} root without
 * post-number collisions.
 */
